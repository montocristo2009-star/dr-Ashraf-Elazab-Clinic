...
// 1. الصورة الأساسية (للصفحة الرئيسية فقط)
export const DOCTOR_IMAGE_URL = GITHUB_RAW_BASE + "IMG_7772.jpeg"; 

// 2. الصورة العامة لكافة الصفحات الداخلية (dr-ashraf.jpg)
...
export const SURGICAL_SERVICES: Service[] = [
  ...
  { id: 'elbow-pain', title: 'علاج كوع التنس الجولف', description: 'حلول فعالة لالتهابات الأوتار حول الكوع الناتجة عن المجهود الزائد أو الإصابة.', icon: '🎾' },
